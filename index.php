...
<a href="AffichageSoldeEntre.php" class="btn btn-success" style="float:left;margin-bottom:20px; margin-right: 3px;">Solde entrer</a>
<a href="AffichageSoldeSorti.php" class="btn btn-success" style="float:left;margin-bottom:20px;">Solde sortie</a>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="modifier.php?ideglise=<?php echo $row['ideglise']; ?>" class="btn btn-success">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete.php?ideglise=<?php echo $row['ideglise']; ?>" class="btn btn-danger">Confirmer</a>
      </div>
    </div>
  </div>
</div>
