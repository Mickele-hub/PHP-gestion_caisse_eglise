...
if ($_SERVER["REQUEST_METHOD"] === "GET") {
    ...
    $query = "SELECT entre.*, eglise.Design FROM entre INNER JOIN eglise ON entre.ideglise = eglise.ideglise WHERE motif LIKE :motifRecherche";
    ...
    if (isset($_GET['ideglise'])) {
        ...
        $query = "SELECT entre.*, eglise.Design FROM entre INNER JOIN eglise ON entre.ideglise = eglise.ideglise WHERE eglise.ideglise = :ideglise";
        $valider = $pdo->prepare($query);
